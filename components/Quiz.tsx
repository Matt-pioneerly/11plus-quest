    ...
    <div className="p-4 max-w-4xl mx-auto relative">
      ...
      {currentView === 'home' && (
        <div className="animate-slide-in">
          ...
          {/* Mock Exams */}
          <h3 className="text-purple-300 mb-4 text-sm font-semibold">🎯 Mock Exams</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <button
              onClick={startFullMockExam}
              className="glass-card p-6 text-left border-2 border-red-500/40 hover:border-red-500/60 animate-pulse-glow transition-all"
            >
      ...
      {currentView === 'levels' && currentSubject && isSubject(currentSubject) && (
        <div className="animate-slide-in">
          ...
          <div className="glass-card p-6 text-center mb-6">
            ...
            <p className="text-gray-500 mt-1">Choose your level!</p>
          </div>
